...
const PaymentOption = () => {
  ...
  return (
    <Container>
      ...
      {payment === 'confirming' ? <img src={Paymachine} alt="" width={'45%'} /> : payment === 'success' ? <div></div> : payment === 'credit_card' ? <img src={Bancomat} alt="" /> : payment === 'buono_fedelta' ? <img src={BancoFedelta} alt="" /> : payment === 'satispay' ? <img src={Satispay} alt="" /> : payment === 'gift_card' ? <img src={CarteRegalo} alt="" /> : <img src={Bancomat} alt="" />}
    </Container>
  )
};
